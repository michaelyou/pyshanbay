...
default_configfile = os.path.join(BASE_DIR, 'pyshanb.conf')

class Settings(object):
    def __init__(self, configfile=None, username=None, password=None):
        if configfile is None:
            configfile = default_configfile
        print default_configfile
    ...
    def settings(self):
        ...
        #
        self.site = 'https://api.shanbay.com/bdc'
        #self.site = 'http://www.shanbay.com/'
        self.url_login = 'http://www.shanbay.com/accounts/login/'
        self.api_get_word = self.site + '/search/?word=%s'
        self.api_add_word = self.site + '/learning/'
        self.api_get_example = self.site + '/example/?vocabulary_id={id}&type={type}'
        self.api_get_user_info = 'https://api.shanbay.com/account/'
        self.api_add_example = self.site + '/example/'
